...
int main(void)
{
	...
	window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Alpha Blending", nullptr, nullptr);
	if (!window)
	{
		glfwTerminate();
		return -1;
    ...
    transparentLayout.Push<float>(3); // position
    transparentLayout.Push<float>(2); // texture coords
    ...
    Texture transparentTexture("resource/textures/window.png");
    ...
    transparentVAO.UnBindVertexArray();
    cubeVBO.UnBindVertexBuffer();
    planeVBO.UnBindVertexBuffer();
    transparentVBO.UnBindVertexBuffer();
    shader.UnBindShader();
	...
	while (!glfwWindowShouldClose(window))
	{
        ...
        transparentVAO.BindVertexArray();
        transparentTexture.BindTexture(0);

...
int main(void)
{
    ...
    window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Exploding effects", nullptr, nullptr);
    if (!window)
    {
        glfwTerminate();
        return -1;
    ...
    std::string geometryShaderSource = "resource/shaders/geometry_shader.glsl";
    std::string fragmentShaderSource = "resource/shaders/fragment_shader.glsl";

    Shader shader = Shader(vertexShaderSource, fragmentShaderSource, geometryShaderSource);

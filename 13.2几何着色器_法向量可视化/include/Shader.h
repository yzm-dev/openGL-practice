...
public:
	Shader(const std::string& m_VertexFilePath, const std::string& m_FragmentFilePath, const std::string& m_GeometryFilePath="");
	~Shader();
...
private:
	...
	unsigned int CreateShader(const std::string& vertexShaderSource, const std::string& fragmentShaderSource, const std::string& geometryShaderSource="");

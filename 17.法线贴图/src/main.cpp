...
int main(void)
{
	...
	window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Normal Texture", nullptr, nullptr);
	if (!window)
	{
		glfwTerminate();
		return -1;
    ...
    // load textures
    std::string diffuseMapPath = "resource/textures/brickwall.jpg";
    std::string normalMapPath = "resource/textures/brickwall_normal.jpg";
